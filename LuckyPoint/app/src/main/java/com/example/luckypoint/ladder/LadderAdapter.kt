...
class LadderAdapter(val context: Context, val dataList: ArrayList<Data>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val textView: TextView = view.findViewById(R.id.tv_number)
        val editText: EditText = view.findViewById(R.id.ed_name)
